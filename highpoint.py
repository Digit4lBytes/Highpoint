...
#This function is for  Dorking, or any Google Query with Selenium
def googleSearch(queries, output_mode,tld):
    ...
    if(output_mode == "-t"):
        for query in queries:
            ...
            time.sleep(6)
            print("Waiting to skip automated bot detection...")
...
def googleDork(args):
    if(args[1] == "-fp"):
        ...
        print("General Usage: python highpoint.py <dork> <output_mode> <tld>")
        print("Dorks:")
        ...
        print("<tld> is for the top level domain or target site you're google dorking. Example: bbc.co.uk or .org")
    else:
        print("Unknown argument, use highpoint.py -help for help.")
